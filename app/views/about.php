...
<html lang="en">
  ...
  <body class="goto-here">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item "><a href="../../index.php" class="nav-link">Home</a></li>
	          <li class="nav-item dropdown"><a class="nav-link " href="model.php" >3D Models</a></li>
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(static/image/sddefault.jpg);">
						<a href="./static/videos/videoplayback.mp4" class="icon popup-vimeo d-flex justify-content-center align-items-center">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Stablished Sinced 1886</h2>
	            </div>
	          </div>
	          <div class="pb-md-5 pb-4">
              <p>Since our inception in 1886, Coca-Cola has been quenching thirsts and sparking moments of happiness around the globe. Our journey began with a single sip, and since then, we've been on a mission to refresh the world in mind, body, and spirit.</p>
              <p>Experience the joy of Coca-Cola as we continue to innovate and spread smiles, one delicious beverage at a time.</p></div>
					</div>
				</div>
			</div>
		</section>
    ...
    <section class="ftco-gallery" style="margin-top: 5%;">
    	<div class="container">
