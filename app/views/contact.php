  ...
  <body class="goto-here">
    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Email:</span> <a href="mailto:gbmedia@coca-cola.com">gbmedia@coca-cola.com</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Website</span> <a href="http://www.coca-cola.com/gb/en">www.coca-cola.com</a></p>
	          </div>
          </div>
        </div>
